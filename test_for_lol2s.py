...
# ✅ 保持原样：创建保存目录
save_img_root = '/home/leng/data/qtacefz/the01/result'
...
if __name__ == '__main__':
    ...
    network.load_state_dict(torch.load('/home/leng/data/qtacefz/the01/saved_models/lowlight/sfhformer_lol_strain_lolv2s_best.pth')['state_dict'])
